...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) => MaterialApp(
    ...
    initialRoute: AppRouterConfig.initialRoute,
...
class _AppHomepageState extends State<AppHomepage> {
    ...
    body: Center(
      child: Column(
        ...
        children: [
          ...
          TextButton(
            onPressed: () => _jumpToAboutPage(context),
            child: Text("关于页"),
          ),
          OutlinedButton(
            onPressed: () => _jumpToDetailPageByPushNamed(context),
            child: Text("详情页2"),
          ),
          FilledButton(
            onPressed: () => _jumpToSettingsPage(context),
            child: Text("设置页"),
          ),
        ],
      ),
  ...
  void _jumpToAboutPage(BuildContext context) async {
    final res = await Navigator.of(
      context,
    ).pushNamed(AppAboutPage.routeName, arguments: "A msg from home.");
  ...
  void _jumpToDetailPageByPushNamed(BuildContext context) {
    Navigator.pushNamed(
      context,
      AppDetailPage.routeName,
      arguments: "你好, 我是详情页2",
    );
  }

  void _jumpToSettingsPage(BuildContext context) {
