...
class _AppHomePageState extends State<AppHomePage> {
  ...
  ///  GlobalKey 可以帮助我们访问某个 Widget 中的信息, 包括 Widget 或 State 或 Element 等对象
  final GlobalKey<_ListStatefulItemState> _globalKey = GlobalKey();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListStatefulItem(name: _nameList[0], key: _globalKey),
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          print("当前的 msg 为 : ${_globalKey.currentState?.msg}");
          print("当前的 name 为 : ${_globalKey.currentState?.widget._myName}");
        },
