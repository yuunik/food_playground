...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    if (<CategoryModel>[] is M) {
      return data.map<CategoryModel>((Map<String, dynamic> e) =>
          CategoryModel.fromJson(e)).toList() as M;
    }
    if (<MealModel>[] is M) {
      return data.map<MealModel>((Map<String, dynamic> e) =>
          MealModel.fromJson(e)).toList() as M;
    }
...
class JsonConvertClassCollection {
  Map<String, JsonConvertFunction> convertFuncMap = {
    (CategoryModel).toString(): CategoryModel.fromJson,
    (MealModel).toString(): MealModel.fromJson,
  };
