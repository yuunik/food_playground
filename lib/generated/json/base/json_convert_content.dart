...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    if (<MovieModel>[] is M) {
      return data
              .map<MovieModel>(
                (Map<String, dynamic> e) => MovieModel.fromJson(e),
              )
              .toList()
          as M;
    }
    if (<MovieData>[] is M) {
      return data
              .map<MovieData>((Map<String, dynamic> e) => MovieData.fromJson(e))
              .toList()
          as M;
    }
...
class JsonConvertClassCollection {
  Map<String, JsonConvertFunction> convertFuncMap = {
    (MovieModel).toString(): MovieModel.fromJson,
    (MovieData).toString(): MovieData.fromJson,
  };
